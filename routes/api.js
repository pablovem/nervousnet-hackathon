    ...
    if(exists){
      ...
      csv
       ...
       .on("data", function(data){
         ...
         subdata["average_local_error"].push(parseFloat(data["average_local_error"]));
         subdata["global_error"].push(parseFloat(data["global_error"]));
       })
       .on("end", function(){
         //Fix wrong csv generated by analyser
         subdata["entropy"].pop();
         subdata["diversity"].pop();
         subdata["average_local_error"].pop();
         subdata["global_error"].pop();
         res.json(subdata);
       });
    } else {
